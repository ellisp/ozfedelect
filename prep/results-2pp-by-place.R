...
#------------------------2019--------------------
url <- "https://results.aec.gov.au/24310/Website/Downloads/HouseTppByPollingPlaceDownload-24310.csv"

destfile = "raw-data/HouseTppByPollingPlace2019.csv"
download_if_fresh(url, destfile = destfile)

hr_2019_2pp <- read_csv(destfile, skip = 1) %>%
...
sum(hr_2019_2pp$australian_labor_party_votes)
sum(hr_2019_2pp$liberal_national_coalition_votes)
